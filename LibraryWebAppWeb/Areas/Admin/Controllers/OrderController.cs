...
namespace LibraryWebAppWeb.Areas.Admin.Controllers
{
	...
	public class OrderController : Controller
	{
		...
		// Afișează pagina principală a comenzilor.
		...
		// Actualizează detaliile unei comenzi.
		...
		[HttpPost]
		[Authorize(Roles = SD.Role_Admin + "," + SD.Role_Employee)]
		// Începe procesarea unei comenzi.
		...
		[ActionName("Details")]
		[HttpPost]
		// Inițiază plata pentru o comandă.
		...
		[HttpGet]
		// Obține toate comenzile pentru afișare în format JSON.
